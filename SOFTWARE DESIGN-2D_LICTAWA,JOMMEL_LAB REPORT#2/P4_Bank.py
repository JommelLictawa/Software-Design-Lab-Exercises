...
class SavingsAccount(object):
    RATE = 0.02 #applied to the account
...
#implementations of methods
    ...
    def computeInterest(self):
        ...
        interest = self._balance * SavingsAccount.RATE #calculation of interest
...
def testBank(self,number = 0):
    ...
    for i in xrange(number):
        ...
        bank.add(SavingsAccount('Jommel.Engr' + str(i + 1),str(1000 + i),100.00))
